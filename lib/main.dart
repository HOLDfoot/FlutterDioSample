...
import 'package:flutter_net_demo/net/api/app_api.dart';
import 'package:flutter_net_demo/net/api/bean/weather_bean.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Flutter Dio\'s 封装'),
    );
  }
}
